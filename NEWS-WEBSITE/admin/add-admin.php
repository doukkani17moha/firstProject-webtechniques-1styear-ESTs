...
if (strlen($_SESSION['login']) == 0) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $status = 1;
    $query = mysqli_query($con, "insert into tbladmin(AdminUserName,AdminPassword,AdminEmailId,Is_Active) values('$adminname','$hashedpass','$adminemail','$status')");
    if ($query) {
      $msg = "Admin created ";
    } else {
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card-box">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <form class="form-horizontal" name="Admin" method="post">
