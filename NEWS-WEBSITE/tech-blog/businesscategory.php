...
<!-- Site Metas -->
<title>techblog | Business News</title>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
            <h2><i class="fa fa-gears bg-orange"></i> Business <small class="hidden-xs-down hidden-sm-down">All Business News. </small></h2>
          </div><!-- end col -->
          <div class="col-lg-4 col-md-4 col-sm-12 hidden-xs-down hidden-sm-down">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active"><a href="businesscategory.php">Business</a></li>
            </ol>
          </div><!-- end col -->
        </div><!-- end row -->
      </div><!-- end container -->
