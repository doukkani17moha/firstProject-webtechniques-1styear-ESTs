                ...
                <div class="masonry-blog clearfix">
                    <div class="first-slot">
                        <div class="masonry-box post-media">
                            <img src="upload/hacking.jpg" alt="" class="img-fluid">
                            <div class="shadoweffect">
                                <div class="shadow-desc">
                                    <div class="blog-meta">
                                        <span class="bg-orange"><a title="" href="techcategory.php">Technology</a></span>
                                        <h4><a href="readpost.php?nid=27" title="">10 Biggest Cyber Attacks in History </a></h4>
                                        <small><a href="readpost.php?nid=27" title="">24 Juin, 2023</a></small>
                                    </div><!-- end meta -->
                                </div><!-- end shadow-desc -->
                            </div><!-- end shadow -->
                        </div><!-- end post-media -->
                    ...
                    <div class="second-slot">
                        <div class="masonry-box post-media">
                            <img src="upload/ai.jpg" alt="" class="img-fluid">
                            <div class="shadoweffect">
                                <div class="shadow-desc">
                                    <div class="blog-meta">
                                        <span class="bg-orange"><a href="techcategory.php" title="">Technology</a></span>
                                        <h4><a href="readpost.php?nid=26" title="">What Is Artificial Intelligence? </a></h4>
                                        <small><a href="readpost.php?nid=26" title="">28 Juin, 2023</a></small>
                                    </div><!-- end meta -->
                                </div><!-- end shadow-desc -->
                            </div><!-- end shadow -->
                        </div><!-- end post-media -->
                    ...
                    <div class="last-slot">
                        <div class="masonry-box post-media">
                            <img src="upload/linux.jpg" alt="" class="img-fluid">
                            <div class="shadoweffect">
                                <div class="shadow-desc">
                                    <div class="blog-meta">
                                        <span class="bg-orange"><a href="techcategory.php" title="">Technology</a></span>
                                        <h4><a href="readpost.php?nid=25" title="">What is Linux?</a></h4>
                                        <small><a href="readpost.php?nid=25" title="">01 Juin, 2023</a></small>
                                    </div><!-- end meta -->
                                </div><!-- end shadow-desc -->
                            </div><!-- end shadow -->
                        </div><!-- end post-media -->
                                ...
                                ?>
                                    <div class="blog-box row">
                                        ...
                                        <div class="blog-meta big-meta col-md-8">
                                            ...
                                            <small class="firstsmall"><a class="bg-orange" href="readpost.php?nid=<?php echo htmlentities($row['pid']) ?>" title=""><?php echo htmlentities($row['category']); ?></a></small>
